...
import com.HuangZhiCheng.model.Payment;
...
/**
 * @author : hzc
 * @date: 2021/6/4 - 06 - 04 - 11:14
 * @Description: ${PACKAGE_NAME}
 * @version: 1.0
 */
@WebServlet(name = "OrderServlet",value = "/order")
public class OrderServlet extends HttpServlet {
    private static final long serialVersionUID = 7445858314195706531L;
...
//        save order
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("paymenTypetList",paymenTypetList);
        String path = "/WEB-INF/views/order.jsp";
        request.getRequestDispatcher(path).forward(request,response);
    }
}
