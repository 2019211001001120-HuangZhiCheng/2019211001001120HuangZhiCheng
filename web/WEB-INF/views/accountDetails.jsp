...
<%@ page import="com.HuangZhiCheng.model.User" %>
	<section id="z`z`">
		<div class="container">
			<div class="step-one">
			...
			<h1>No Order Found.</h1>
					...
					<!-- loop_start -->
						...
						<p> ${o.address1}</p>
						<p>${o.address2}</p>
						<p>${o.city},${o.state},${o.city}country-${o.postalCode}</p>
						<p>${o.phone}</p>
						</td>
						<td class="cart_total">
						<%
							com.HuangZhiCheng.model.Order o=(com.HuangZhiCheng.model.Order)pageContext.findAttribute("o");
							int n=o.getPaymentId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							String paymentType=com.HuangZhiCheng.model.Payment.findByPaymentId(con,n);
							 %>
