<%@ page import="com.HuangZhiCheng.model.Product" %>
<%@ page import="java.sql.Connection" %>
<%@ page import="com.HuangZhiCheng.model.Category" %>
					...
					<c:forEach var="p" items="${requestScope.productList}">
						<tr>
							...
							<%
								...
								String cateName = Category.findByCategoryId(con, pid);
							%>

							<td class="cart_quantity"><%=cateName%></td>
